...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	HotkeyEngine::KeyPressFn OnCtrlAltBS=std::bind(SnkHkFn::OnTriplet, SnkHkFn::OnCtrlAlt, VK_BACK, false, std::placeholders::_1, std::placeholders::_2);
	...
	if (!SnkHotkey->StartNew(std::move(OnCtrlAltBS))) {
